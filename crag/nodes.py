...
class CragNodes:
    ...
    def __init__(self, model, kdb_retriever, web_retriever, preferred_language="Spanish"):
        self.model = model
        self.kdb_retriever = kdb_retriever
    ...
    def retrieve(self, state):
        ...
        # Retrieval
        documents = self.kdb_retriever.invoke(question)
    ...
    def rewrite(self, state):
        ...
        response = question_rewriter.rewriter_chain.invoke({"messages": messages})
    ...
    def generate(self, state):
        ...
        generation = generator.question_answer_chain.invoke({
            "context": documents, "question": question, "language": self.preferred_language
        })
    ...
    def grade_documents(self, state):
        ...
        web_search = "No"
        for d in documents:
            score = retrieval_grader.retrieval_grader_chain.invoke(
    ...
    def transform_query(self, state):
        ...
        # Re-write question
        question_rewriter = QuestionRewriter(self.model)
        better_question = question_rewriter.rewriter_chain.invoke({"question": question})
    ...
    def web_search(self, state):
        ...
        print(question)
        # Web search
        docs = self.web_retriever.invoke({"query": question})
        print(docs)
